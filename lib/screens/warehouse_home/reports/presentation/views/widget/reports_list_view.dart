            ...
            builder: (contextGetFile, stateGetFile) {
              return BlocConsumer<DeleteReportCubit, DeleteReportState>(
                listener: (contextInner, stateInner) {
                  if (stateInner is DeleteReportSuccess) {
                    contextInner.read<AllReportCubit>().fetchAllReports(paginate: paginate);
                  ...
                  } else if (stateInner is DeleteReportFailure) {
                            ...
                            children: [
                              ...
                              state.allReport.to! < state.allReport.total ? GestureDetector(
                                      onTap: () {
                                        ...
                                        contextInner.read<AllReportCubit>().fetchAllReports(paginate: cubit.afterIncreasePaginate,);
                                      },
                                      child: SizedBox(
                                        height: 50.0,
