                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        state.item.expiredDate!.isNotEmpty ? const Spacer() : const SizedBox(height: 0, width: 0,),
                        state.item.expiredDate!.isNotEmpty ? Row(
                          mainAxisSize: MainAxisSize.max,
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                        ...
                        state.item.minimumQuantity != null ? const Spacer() : const SizedBox(height: 0, width: 0,),
                        state.item.minimumQuantity != null ? Row(
                          mainAxisSize: MainAxisSize.max,
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
