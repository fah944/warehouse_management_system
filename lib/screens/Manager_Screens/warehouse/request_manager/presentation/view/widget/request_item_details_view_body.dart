...
class RequestItemDetailsViewBody extends StatelessWidget {
  ...
  String getQuantity(String list){
    log("j quantity $j");
    log("k initial $k");
    String quantity = allRequestItem.requsetPending[k+11] + allRequestItem.requsetPending[k+12] + allRequestItem.requsetPending[k+18] +
        allRequestItem.requsetPending[k+19] +
        allRequestItem.requsetPending[k+20] + allRequestItem.requsetPending[k+21] + allRequestItem.requsetPending[k+22] + allRequestItem.requsetPending[k+23];
    String name1 = "";
    int i = 0;
  ...
  String getMinQuantity(String list){
    log("f initial $f");
    String quantity = allRequestItem.requsetPending[f+21] + allRequestItem.requsetPending[f+22] + allRequestItem.requsetPending[f+18] +
        allRequestItem.requsetPending[f+19] +
        allRequestItem.requsetPending[f+20] + allRequestItem.requsetPending[f+21] + allRequestItem.requsetPending[f+22] + allRequestItem.requsetPending[f+23];
    String name1 = "";
    int i = 0;
    ...
    g = i;
    log("f end $f");
    log("Min Quantity  $quantity");
    return name1;
  }
  String getDescription(String list){
    log("f description $f");
    log("g initial $g");
    String description = allRequestItem.requsetPending[g+18] + allRequestItem.requsetPending[g+12] + allRequestItem.requsetPending[k+18] +
        allRequestItem.requsetPending[k+19] +
        allRequestItem.requsetPending[k+20] + allRequestItem.requsetPending[k+21] + allRequestItem.requsetPending[k+22] + allRequestItem.requsetPending[k+23];
    String name1 = "";
    int i = 0;
