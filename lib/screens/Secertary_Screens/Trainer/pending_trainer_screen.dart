        ...
        return BlocProvider.value(
          ...
          child: BlocConsumer<TrainerCubit, TrainerState>(
            ...
            builder: (context, state) {
              ...
              return AlertDialog(
                title: const Text('Create a New Trainer'),
                content: Form(
                  key: formKey,
                    ...
                    child: Column(
                      children: <Widget>[
                        TextFormField(
                          ...
                          validator: (value) => value!.isEmpty ? 'Please enter the trainer name' : null,
                        ...
                        TextFormField(
                          ...
                          validator: (value) => value!.isEmpty ? 'Please enter the trainer address' : null,
                          onSaved: (value) => address = value!,
                        ),
                        TextFormField(
                          decoration: const InputDecoration(labelText: 'Specialty'),
                          validator: (value) => value!.isEmpty ? 'Please enter the specialty' : null,
